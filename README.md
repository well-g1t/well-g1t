...
| --- | --- | --- |
| **WSoft Studio** | Agenda, clientes, caixa diário, estoque, programa de fidelidade e lembretes automáticos por WhatsApp | React, Flask, PostgreSQL, Docker |
| **WSoft Estoque** *(em desenvolvimento)* | Venda por bipagem pela câmera do celular, controle por tamanho e variação, histórico de movimentações | Node.js, Express, SQLite, PWA |
| **WSoft Manager** | Clientes, orçamentos, contratações, cobrança recorrente e hospedagens, com relatórios em PDF e CSV | Django, PostgreSQL, ReportLab |
...
- Aprofundando arquitetura de aplicações, testes automatizados e qualidade de código
- Estudando segurança e boas práticas de publicação: variáveis de ambiente, HTTPS, backup e rotina de deploy
- Levando os sistemas que entrego para Docker, com publicação e backup automatizados
